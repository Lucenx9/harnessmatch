...
The recommender is a decision-support workflow, not a marketing conversion funnel.
...
- Four decision outputs use four columns on desktop and two columns on narrow screens.
- Long evidence labels wrap naturally and never force horizontal scrolling.
