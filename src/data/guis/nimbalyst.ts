...
export const nimbalyst: GuiProduct = {
  ...
  summary: "A visual editor and session manager for agent work across documents, mockups, code, tasks, Git, and shared team artifacts.",
  bestFor: "Visual workflows that need rich file editors, agent sessions, worktrees, mobile follow-up, and collaborative documents or trackers in one project space.",
  limitation: "OpenCode and Copilot support are marked alpha. Teams Beta documents shared artifacts and agent-visible context, but not teammates sharing or steering the same live coding-agent session.",
  capabilities: {
