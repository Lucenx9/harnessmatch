...
export const harnesses: Harness[] = [
  ...
  },
  {
    ...
    summary:
      "Moonshot AI's MIT-licensed coding harness provides a terminal UI, structured print mode, multi-provider routing, MCP, skills, hooks, ACP editor integration, a local web service, and parallel foreground or background subagents.",
    logo: {
    ...
    evidence: [
      ...
      },
      {
        ...
        covers: "Structured print mode, permission modes, ACP integration, local web service, session selection, and output formats",
        kind: "official-docs",
        verifiedAt: kimiCodeVerifiedAt,
      },
      {
      ...
      },
      {
        ...
        covers: "Local message-event persistence, resume, replay, fork, subagent history, and export without claiming learned cross-session memory",
        kind: "official-docs",
        verifiedAt: kimiCodeVerifiedAt,
      },
      {
