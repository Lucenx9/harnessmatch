...
export const harnesses: Harness[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      {
        title: "Junie 2512.1 support repository",
        url: "https://github.com/JetBrains/junie/tree/710dd0e480c1943f34c7a15c355709bc93e41114",
  ...
  },
  {
    ...
    evidence: [
      {
        title: "Kimi Code 0.29.1 source snapshot",
        url: "https://github.com/MoonshotAI/kimi-code/tree/f4c3967a417a539372eadab6c809d27b8a14c005",
        covers: "Immutable MIT source snapshot for the audited release, including 1,250 test-like files and eight workflows but no dedicated product-evaluation suite",
        kind: "official-repository",
        verifiedAt: kimiCodeVerifiedAt,
      },
      {
        title: "Kimi Code 0.29.1 release",
        url: "https://github.com/MoonshotAI/kimi-code/releases/tag/%40moonshot-ai%2Fkimi-code%400.29.1",
  ...
  },
  {
    ...
    summary:
      "An Apache-2.0 stateful agent harness with self-editing memory, skills, hooks, MCP, synchronous or asynchronous subagents, headless execution, multi-provider access, and selectable local, remote, or managed cloud environments.",
    logo: {
    ...
    tradeoffs: [
      ...
      "Local client tools execute on the host even when agent state lives in Letta Cloud",
    ...
    evidence: [
      ...
      },
      {
        ...
        url: "https://docs.letta.com/guides/ade/desktop/",
        covers: "CLI, desktop and web surfaces, headless mode, coding-plan access, shared persistent memory, parallel conversations, and web search",
        kind: "official-docs",
        verifiedAt: lettaCodeVerifiedAt,
      },
      {
        title: "Client-side tools",
        url: "https://docs.letta.com/guides/core-concepts/tools/client-tools/",
        covers: "Local coding-tool execution, approval handoff, host boundaries, server tools, and remote sandbox distinction",
        kind: "official-docs",
        verifiedAt: lettaCodeVerifiedAt,
      },
      {
        title: "Persistent agent model",
        url: "https://docs.letta.com/guides/get-started/for-agents",
        covers: "Database-backed agent state, persistent memory blocks, conversation search, client/server boundaries, and self-hosting",
        kind: "official-docs",
        verifiedAt: lettaCodeVerifiedAt,
      },
      {
