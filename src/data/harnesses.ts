    ...
    evidence: [
      {
        ...
        covers: "Agent Canvas, multiple agent backends, automations, deployment modes, and split licensing",
        kind: "official-repository",
        verifiedAt,
      },
      {
      ...
      },
      {
        ...
        url: "https://docs.openhands.dev/sdk/index",
        covers: "Python and REST APIs, local and cloud execution, tools, and multi-agent workflows",
        kind: "official-docs",
        verifiedAt,
      },
      {
