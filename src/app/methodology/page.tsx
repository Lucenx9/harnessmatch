    ...
    <section className="section page-section">
      <div className="shell narrow-shell prose-page">
        ...
        <section className="prose-section" id="gui-classification">
          ...
          <p>GUI profiles group each source by one primary presentation topic in this fixed order: {guiEvidenceTopicOrder.map((topic) => guiEvidenceTopicLabels[topic]).join(", ")}. Each group shows {guiEvidencePreviewLimit === 1 ? "one source" : `the first ${guiEvidencePreviewLimit} sources`} in record order and keeps every remaining source available behind a disclosure. Topic placement organizes the ledger only; it does not transfer harness capability, rank sources, or change workflow fit.</p>
        </section>
