    ...
    <section className="section page-section">
      <div className="shell narrow-shell prose-page">
        ...
        <section className="prose-section" id="eligibility">
          ...
          <p>The Usage page also refreshes exact artifact mappings from the <a href="https://formulae.brew.sh/docs/api/" target="_blank" rel="noreferrer">Homebrew analytics API</a>, the <a href="https://github.com/npm/download-counts" target="_blank" rel="noreferrer">npm downloads API</a>, the public <a href="https://learn.microsoft.com/en-us/javascript/api/azure-devops-extension-api/eventcounts" target="_blank" rel="noreferrer">VS Code Marketplace install metric</a>, and the <a href="https://docs.github.com/en/rest/activity/starring" target="_blank" rel="noreferrer">GitHub stars API</a>. Homebrew 30d events and npm last-month downloads are rolling distribution-channel observations. VS Code installs and GitHub stars are cumulative. GitHub rows preserve whether the audited repository contains full source, client source, or only support material. Downloads, installs, stars, tokens, and requests observe different populations and denominators, so they remain separate views and separate CSV rows. Missing coverage means no admitted mapping, not zero adoption. None of these signals changes recommendation order, evidence state, capability classification, or benchmark interpretation.</p>
